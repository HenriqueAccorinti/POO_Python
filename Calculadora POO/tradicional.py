...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(200, 300, 311, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.gridLayoutWidget = QtWidgets.QWidget(Dialog)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(20, 50, 495, 205))
        ...
        self.gridLayout.addWidget(self.pushButton_13, 4, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_30, 3, 4, 1, 1)
        self.pushButton_21 = QtWidgets.QPushButton(Dialog)
        self.pushButton_21.setGeometry(QtCore.QRect(20, 300, 75, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_21.setText(_translate("Dialog", "Voltar"))
